...
energía renovable (Sánchez-López, 2023). Los depósitos más
...
(Gutiérrez & Ruiz-León, 2024; Jerez, Garcés & Torres, 2021).
...
lagunas y humedales (Jerez et al., 2021). A esto se añade un
...
(Bodin & Crona, 2009). La gobernanza colaborativa de recursos
...
resolverse y cuáles se enquistan.
...
de datos —por ejemplo, la dualidad de personas y grupos de Breiger (1974) o los
modelos de interlocks de directorios (Koskinen & Edling, 2012)—, y ambos
...
testimonio parlamentario (Leifeld, 2017) e interlocks desde registros de
directorios (Koskinen & Edling, 2012). La limitación correlativa debe declararse:
